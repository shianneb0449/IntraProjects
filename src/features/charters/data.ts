...
export interface MockCharter {
  id: string; title: string; owner: string; ownerInitials: string;
  status: CharterStatus; priority: Priority; progress: number;
  taskCount: number; completedTasks: number; startDate: string;
  targetDate: string; department: string;
}
